		...
		verb.Settings{
			...
			Bridges: []verb.Bridge{
				bridges.UserSessionRequired{
					Excludes: []string{
						"/", "", "/login", "/user", "/user/login", "/user/login-success",
						"/htmx/form-user_signup", "/questionnaire", "/questionnaire/step-2",
						"/questionnaire/step-3", "/create-login", "/guest",
						"/htmx/searchbar-manual_search",
						"/htmx/tab-products",
						"/htmx/btn-add_product",
						"/htmx/section-your_products",
						"/htmx/section-recommended_products",
						"/htmx/tab-ingredients",
						"/htmx/tab-compare",
						"/htmx/tab-user_dashboard",
						"/htmx/table-tagging_rules",
						"/htmx/table-compare",
						"/htmx/searchbar-compare",
						"/htmx/compare-search_results",
						"/htmx/table-compare",
						"/htmx/searchbar-compare",
					},
				},
